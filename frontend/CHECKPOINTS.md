...
- [ ] `pnpm run build` returns green (no automated test suite configured yet — see `docs/verification.md`; update this line if one is added and `verify_command` is set).
