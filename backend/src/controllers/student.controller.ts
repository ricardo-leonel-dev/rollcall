...
import * as svc from '../services/student.service';
...
router.get('/',    requirePermission(R,'read'),   async (req, res) => res.json(await svc.findAll(req.institutionId!, req.courseIds ?? null, req.query.search as string)));
