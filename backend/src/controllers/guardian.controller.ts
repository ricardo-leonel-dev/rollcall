...
import * as svc from '../services/guardian.service';
...
router.get('/',    requirePermission(R,'read'),   async (req, res) => res.json(await svc.findAll(req.institutionId!, req.query.search as string)));
